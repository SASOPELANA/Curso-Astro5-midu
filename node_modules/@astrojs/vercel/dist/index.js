                    ...
                    integrations: [
                        {
                            ...
                            hooks: {
                                'astro:build:done': async () => {
                                    ...
                                    const staticDir = _buildOutput === 'static' ? _config.outDir : _config.build.client;
                ...
                if (_buildOutput === 'server') {
                    ...
                    if (config.trailingSlash &&
                        ...
                        try {
                            ...
                            if ((vercelConfig.trailingSlash === true && config.trailingSlash === 'never') ||
...
`);
            ...
            'astro:build:done': async ({ logger }) => {
                ...
                if (error) {
                    throw new AstroError(`Error generating redirects: ${error.message}`, error.link ? `${error.action ?? 'More info'}: ${error.link}` : undefined);
                }
                let images;
                ...
                if (normalized.error) {
                    throw new AstroError(`Error generating routes: ${normalized.error.message}`, normalized.error.link
